...
urlpatterns = [
    ...
    path('deleteEmp/<str:eFname>', views.deleteEmp, name='delete'),
    path('editemp/<str:eFname>', views.editemp, name='edit'),
    path('updateEmp/<str:eFname>', views.updateEmp, name='update'),
